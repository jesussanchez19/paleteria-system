...
<div class="flex flex-col items-center justify-center min-h-[60vh] text-center">
    ...
    <h1 class="text-3xl font-extrabold mb-2 text-pink-600">¡Algo salió mal!</h1>
    <p class="text-lg text-slate-700 mb-6">Ocurrió un error inesperado en el servidor.<br>Intenta de nuevo más tarde o contacta a soporte.</p>
        @php
            $user = auth()->user();
